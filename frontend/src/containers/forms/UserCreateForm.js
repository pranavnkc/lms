...
const usernameValidator = (values) => {
    return API.get('users/validate-username/', {params:{username:values.username}})
              .then((res) => {
              }, (err)=>{
...
let UserCreateForm = props => {
    ...
    return (
        ...
        <Field component={renderSelectField} icon="fa fa-users" type="select" label="Role" name="role"/>
